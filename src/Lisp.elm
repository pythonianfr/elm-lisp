...
type alias Overrides msg =
    Dict String (Int -> Expr -> (Expr -> List (H.Html msg)) -> List (H.Html msg))
...
view : Expr -> Overrides msg -> List (H.Html msg)
    ...
    case formula of
        Expression expr ->
            [ H.div
                  ...
                  [ H.pre
                    [ HA.class "highlight" ]
                    ([ H.span [] [] ] ++ viewexpr overrides 0 expr)
                  ]
            ]
...
viewexpr : Overrides msg -> Int -> List Expr -> List (H.Html msg)
...
viewargs : Overrides msg -> String -> Int -> Bool -> List Expr -> List (List (H.Html msg))
...
viewatom : Overrides msg -> Int -> Expr -> List (H.Html msg)
...
deadendstostr : List DeadEnd -> String
